...
sensor_params.measurement_std = [0.3, 0.008]; 
...
filter_params.sensor.measurement_std = [0.3, 0.008];
...
% Map PHD config
filter_params.birthGM_intensity = 0.25;             % Default intensity of GM component when birth
