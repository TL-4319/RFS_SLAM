...
% Select dataset
load ('../generated_datasets/rover_3D_8Hz_spaced.mat');
...
sensor_params.measurement_std = [0.1, 0.001, 0.001];  
...
filter_params.sensor.measurement_std = [0.1, 0.001, 0.001];
...
filter_params.survive_prob = 0.9999;
