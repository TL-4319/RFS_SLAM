...
figure(1)
subplot (3,1,1)
plot (dist_travel, slam_pos_error(1,:),'DisplayName',simulation.type,'LineWidth',3)
hold on 
plot (dist_travel, odom_pos_error(1,:),'DisplayName','Odometry','LineWidth',3)
...
subplot (3,1,2)
plot (dist_travel, slam_pos_error(2,:),'DisplayName',simulation.type,'LineWidth',3)
hold on
plot (dist_travel, odom_pos_error(2,:),'DisplayName','Odometry','LineWidth',3)
xlabel("Distance traveled (m)")
grid on
ylabel("Y error (m)")
set(gca,'Fontsize',12)
...
subplot (3,1,3)
plot (dist_travel, slam_pos_error(3,:),'DisplayName',simulation.type,'LineWidth',3)
hold on
plot (dist_travel, odom_pos_error(3,:),'DisplayName','Odometry','LineWidth',3)
xlabel("Distance traveled (m)")
grid on
ylabel("Z error (m)")
set(gca,'Fontsize',12)
...
figure(2)
subplot (3,1,1)
plot (dist_travel, slam_eul_error(1,:)*pi/180,'DisplayName',simulation.type,'LineWidth',3)
hold on 
plot (dist_travel, odom_eul_error(1,:)*pi/180,'DisplayName','Odometry','LineWidth',3)
xlabel("Distance traveled (m)")
grid on
...
subplot (3,1,2)
plot (dist_travel, slam_eul_error(2,:)*pi/180,'DisplayName',simulation.type,'LineWidth',3)
hold on
plot (dist_travel, odom_eul_error(2,:)*pi/180,'DisplayName','Odometry','LineWidth',3)
xlabel("Distance traveled (m)")
grid on
ylabel("Roll error (^o)")
set(gca,'Fontsize',12)
...
subplot (3,1,3)
plot (dist_travel, slam_eul_error(3,:)*pi/180,'DisplayName',simulation.type,'LineWidth',3)
hold on
plot (dist_travel, odom_eul_error(3,:)*pi/180,'DisplayName','Odometry','LineWidth',3)
xlabel("Distance traveled (m)")
grid on
...
hold on
scatter3(est_map(1,:), est_map(2,:), est_map(3,:));
axis equal
