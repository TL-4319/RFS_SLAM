function particle = adaptive_birth_PHD_2D (measurement, filter, prev_particle)
    ...
    for par_ind = 1:size(particle,2)
        ...
        new_meas_world_frame = reproject_meas(particle(1,par_ind).pos, particle(1,par_ind).quat, measurement,filter.sensor);
